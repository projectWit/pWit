...
<div style="position: absolute;">scroll : </div><div id="scroll" style="position: absolute; margin-left: 40px;"></div>
	...
	<div id="ibm-universal-nav">
		...
		<ul id="ibm-menu-links">
			...
			<li onmouseover="slideRibbon(3)"><a href="#">자금 예산</a></li>
			<li onmouseover="slideRibbon(4)"><a href="#">고정 자산</a></li>
			<li onmouseover="slideRibbon(5)"><a href="#">기본 정보</a></li>
		</ul>
	</div>
	...
	<div id="ibm-common-menu" style="display: block; height: 41px; overflow: hidden;">
		...
		<!-- ****************************************************************************************** -->
			<div class="ibm-menu-subtabs ibm-is-hidden" style="display:block; opacity: 1; margin-top: 0px; margin-bottom: 0px;">
				...
				<ul id="subTab-0">
					<li class="subTab-0-0" style="display: block;"><a href="#">매입 전표 관리</a></li>
					<li class="subTab-0-1" style="display: block;"><a href="#">매출 전표 관리</a></li>
					<li class="subTab-0-2" style="display: block;"><a href="#">수금 전표 관리</a></li>
					<li class="subTab-0-3" style="display: block;"><a href="#">외주 전표 관리</a></li>
					<li class="subTab-0-4" style="display: block;"><a href="#">급여 전표 관리</a></li>
					<li class="subTab-0-5" style="display: block;"><a href="#">결산 자료 입력</a></li>
					<li class="subTab-0-6" style="display: block;"><a href="#">고정 자산 등록</a></li>
				</ul>
				...
				<ul id="subTab-1" style="display: none;">
					...
					<li class="subTab-1-3" style="display: block;"><a href="#">원가 명세표</a></li>
					<li class="subTab-1-4" style="display: block;"><a href="#">시산표</a></li>
				</ul>
