...
HeaderWs.makeWs = {
	makeHeaderMenu1 : function() {
		...
		element.push('<area shape="rect" coords="16,3,72,24" href="/member/login.html"/>');
		element.push('<area shape="rect" coords="74,3,125,22" href="/member/join.html"/>');
		element.push('<area shape="rect" coords="127,3,187,22" href="managerPage.html"/>');
		element.push('<area shape="rect" coords="201,4,298,23" href="/link/bookmark.html" target="_blank" onclick="winPop(this.href); return false;"/>');
		element.push('</map>');
		element.push('</div>');
		return element.join('');	
	},
...
FooterWs.makeFooter = function() {
	var _this = this;
	var element = [];
	element.push('<div class="frameWrap" style="border-top:3px solid #000;">');			
	element.push('<div data-section="1" class="frame" style="width:264px;">');			
	element.push('<ul><li>');			
	element.push('<img src="img/ws_down_company.gif" style="width:100%"/>');			
	element.push('</li>');			
	element.push('</ul></div>');			
	element.push('<div data-section="2" class="frame" style="width:230px;">');			
	element.push('<ul><li>');			
	element.push('<img src="img/ws_down_acc.gif" style="width:100%"/>');			
	element.push('</li>');			
	element.push('</ul></div>');			
	element.push('<div data-section="3" class="frame" style="width:246px;">');			
	element.push('<div class="xans-element- xans-board xans-board-listpackage-1 xans-board-listpackage xans-board-1 ">');			
	element.push('<h2><span><img src="img/ws_down_notice.gif"/></span></h2>');			
	element.push('<table border="0" summary="">');			
	element.push('<caption>공지사항</caption>');			
	element.push('<thead><tr>');			
	element.push('<th scope="col">제목</th>');			
	element.push('<th scope="col">날짜</th>');			
	element.push('</tr></thead>');			
	element.push(' <tbody class="xans-element- xans-board xans-board-list-1 xans-board-list xans-board-1">');			
	element.push('<tr class="xans-record-">');			
	element.push('<td class="title">');			
	element.push('<a href="/board/free/read.html?no=1&board_no=1&is_reply_sort=">몰 오픈을 축하합니다.</a>');			
	element.push('</td>');			
	element.push('<td>2014/06/18</td>');			
	element.push('</tr>');			
	element.push('</tbody>');			
	element.push('</table>');			
	element.push('<p class="more">');			
	element.push('<a href="/board/free/list.html?board_no=1">');			
	element.push('<img src="http://img.echosting.cafe24.com/design/skin/default/layout/btn_board_more.gif" alt="더보기"/></a>');			
	element.push('</p></div>');			
	element.push('</div>');			
	element.push('<div data-section="4" class="frame" style="width:260px;">');			
	element.push('<ul><li>');			
	element.push('<img src="img/ws_down_escrow.gif" style="width:100%" usemap="#Map_escrow"/>');			
	element.push('<map name="Map_escrow" id="Map_escrow">');			
	element.push('<area shape="rect" coords="12,12,263,95" href="#" target="_blank"/>');			
	element.push('</map></li>');			
	element.push('</ul></div>');			
	element.push('</div>');			
	element.push('<div>');			
