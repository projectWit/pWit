...
function getCookieTmall(str) {
	...
	for (var i=0; i<binfo.length; i++) {
		...
		if( cKey == "TP" || cKey == "TD" || cKey == "TT" || cKey == "TM" ) continue;
...
function goSOMemberInfoPage() {
	var url = "http://soffice.11st.co.kr/Index.tmall?contentURL=https://soffice.11st.co.kr/register/SellerInfoEdit.tmall?method=sellerInfoEdit" ;
	window.open( url , '','' ) ;
}
// 로그인
...
function setGnbChanel(renew){
	try{
		...
		}else if (url.indexOf("town.11st.co.kr") != -1){
			$ID("lUtilTown").className = $ID("lUtilTown").className +"_on";
			$ID("lUtil11st").innerHTML = '11번가';
 ...
 * **************************************************************************************
 */
function getGnbCtgr(level, ctgrNo, ctgrNm, ctgrCd, selClass, renew)	{
	...
	var global	= [""
	          	   , "http://global.11st.co.kr/global/GlobalAction.tmall?method=globalMain"
	          	   , "http://global.11st.co.kr/global/GlobalCategoryAction.tmall?method=globalMCtgr&dispCtgrNo="
	          	   , "http://global.11st.co.kr/global/GlobalCategoryAction.tmall?method=globalSCtgr&dispCtgrNo="
	          	   , "http://global.11st.co.kr/global/GlobalCategoryAction.tmall?method=globalSCtgr&dispCtgrNo="
	          	   ];
...
try {
	if ( nPartnerCookieValue != '' && window._VIEW_PARTNER_HEADER != false ) {
		if(  nPartnerCookieValue == '1009' || nPartnerCookieValue == '1014' || nPartnerCookieValue == '1037'
	    	|| nPartnerCookieValue == '1041' || nPartnerCookieValue == '1173' || nPartnerCookieValue == '1174'
	    	|| nPartnerCookieValue == '1175' || nPartnerCookieValue == '1176' || nPartnerCookieValue == '1177'
	    	|| nPartnerCookieValue == '1381'
		     ) {  	  // 다음 Header 처리
		 partnerHeaderInfo = '<script language="javascript" src="http://shopping.daum.net/header/shopheader.daum?shopname=11번가&ext=js"></script>';
		 partnerHeaderHeight = 61;
		}else if(  nPartnerCookieValue == '1023' || nPartnerCookieValue == '1038' || nPartnerCookieValue == '1153'
				|| nPartnerCookieValue == '1154' || nPartnerCookieValue == '1155'
			     ) {   // OCB(SK에너지) Header 처리
		  partnerHeaderInfo = '<script language="javascript" src="http://cashbagmall.okcashbag.com/mall/cTop411st.js"></script>';
		  partnerHeaderHeight = 67;
		}else if(  nPartnerCookieValue == '1081' || nPartnerCookieValue == '1143' || nPartnerCookieValue == '1144' ) {   // 포인트뱅킹(띠앗)
																															// Hearder
		  partnerHeaderInfo = '<script type="text/javascript" src="http://www.thiat.com/pointshopping/inc/shopping_11st_header.js"></script> ';
		  partnerHeaderHeight = 71;
		}else if(  nPartnerCookieValue == '1048' || nPartnerCookieValue == '1050' || nPartnerCookieValue == '1051'
				|| nPartnerCookieValue == '1052' || nPartnerCookieValue == '1053' || nPartnerCookieValue == '1055'
				|| nPartnerCookieValue == '1058' || nPartnerCookieValue == '1059' || nPartnerCookieValue == '1060'
				|| nPartnerCookieValue == '1065' || nPartnerCookieValue == '1067' || nPartnerCookieValue == '1086'
				|| nPartnerCookieValue == '1114' || nPartnerCookieValue == '1161' || nPartnerCookieValue == '1162'
				|| nPartnerCookieValue == '1163' || nPartnerCookieValue == '1164' || nPartnerCookieValue == '1165'
				|| nPartnerCookieValue == '1166' || nPartnerCookieValue == '1167' || nPartnerCookieValue == '1193'
				|| nPartnerCookieValue == '1202' || nPartnerCookieValue == '1293' || nPartnerCookieValue == '1475'
				|| nPartnerCookieValue == '1481'
			 	) {   // 네이트 헤더 추가
			partnerHeaderInfo = '<script type="text/javascript" src="http://shopping.nate.com/r/mallheader11st?m=01" charset="utf-8"></script> ';
			partnerHeaderHeight = 87;
		  ...
		  partnerHeaderHeight = 75;
			...
			var partnerChkDate = new Date();
			var partnerChkYear = partnerChkDate.getFullYear().toString();
			var partnerChkMonth = partnerChkDate.getMonth() + 1;
			var partnerChkDay = partnerChkDate.getDate();

			partnerChkMonth = (partnerChkMonth < 10 ? "0" : "") + partnerChkMonth;
			partnerChkDay = (partnerChkDay < 10 ? "0" : "") + partnerChkDay;
			if(location.href.indexOf("https://") > -1 ) {
				partnerHeaderInfo = '<script type="text/javascript" src="https://flyasiana.com/CW/common/linkage/cooperationHeader_euckr.js?mn=11번가&code=SKM"></script>';
			} else {
				partnerHeaderInfo = '<script type="text/javascript" src="http://flyasiana.com/CW/common/linkage/cooperationHeader_euckr.js?mn=11번가&code=SKM"></script>';
			}
			partnerHeaderHeight = 81;
		}else if(  nPartnerCookieValue == '1214' || nPartnerCookieValue == '1252' ) {   // 신한카드
			partnerHeaderInfo = '<script language="javascript" src="https://allthat.shinhancard.com/asn/ASNASNCMN/ASNTitle.shc?type=A028"></script>';
// partnerHeaderInfo = '<script type="text/javascript"
// src="http://www.11st.co.kr/jsp/partners/header/shinhan.jsp"></script>';
			partnerHeaderHeight = 81;
		}else if(  nPartnerCookieValue == '1226') {   // 삼성카드
			partnerHeaderInfo = '<script type="text/javascript" src="http://www.samsungcardmall.com/js/shop/cooper/11st_cooper.js"></script>';
			partnerHeaderHeight = 81;
		}else if(  nPartnerCookieValue == '1247' || nPartnerCookieValue == '1248' ) {	// 컬쳐랜드
			partnerHeaderInfo = '<script type="text/javascript"  src="http://www.cultureland.co.kr/asp/mall/Shopping_cland.js" charset="EUC-KR"></script>';
			partnerHeaderHeight = 91;
		}else if(  nPartnerCookieValue == '1233') {   // 조인스닷컴
			partnerHeaderInfo = '<script type="text/javascript" src="http://shopping.joinsmsn.com/shopping_navi.js"></script>';
			partnerHeaderHeight = 81;
		}else if(  nPartnerCookieValue == '1261') {   // 동양종합금융증권
			partnerHeaderInfo = '<script type="text/javascript" src="http://www.myasset.com/js/11st/tongyang_header.js"></script>';
			partnerHeaderHeight = 81;
		}else if(  nPartnerCookieValue == '1342') {   // 하나SK카드
			partnerHeaderInfo = '<script type="text/javascript" src="http://www.hanaskcard.com/js/shopping.js" charset="euc-kr"></script>';
		...
		}else if(  nPartnerCookieValue == '1362') {   // 가자아이
			partnerHeaderInfo = '<script type="text/javascript" src="http://www.sajai.co.kr/header1.js"></script>';
			partnerHeaderHeight = 75;
		...
		}else if(  nPartnerCookieValue == '1392') {   // 롯데카드몰
			partnerHeaderInfo = '<link rel="stylesheet" type="text/css" href="http://www.lottecard.co.kr/css/corporate_gnb_v2.css" /> '
				+ '<script type="text/javascript"> '
				+ 'function lcElife_menuOver(e){ '
				+ '	for(var i=1; i<=7; i++){ '
				+ '		if(e == 1){ '
				+ '			document.getElementById("elifeMenu07").style.display = "none"; '
				+ '			document.getElementById("elifeMenu01").style.display = "block"; '
				+ '		}else if(e == 7){ '
				+ '			document.getElementById("elifeMenu07").style.display = "block"; '
				+ '			document.getElementById("elifeMenu01").style.display = "none"; '
				+ '		}else{ '
				+ '			document.getElementById("elifeMenu01").style.display = "none"; '
				+ '			document.getElementById("elifeMenu07").style.display = "none"; '
				+ '		} '
				...
				+ '    <div id="lcElife_wrap"> '
				+ '        <div id="lcElife_head"> '
				+ '            <h1><a href="http://www.lottecard.co.kr/elife/" target="_elife"><img src="http://www.lottecard.co.kr/images/elife/logo_lotte_elife2.gif" alt="LOTTE CARD 롯데 e 라이프" /></a></h1> '
				+ '            <h2><a href="http://www.lottecard.co.kr/eshopping/" target="_elife"><img src="http://www.lottecard.co.kr/images/elife/logo_elife_eshopping.gif" alt="롯데카드몰"></a></h2> '
				+ '            <ul class="gnb_elife"> '
				+ '                <li class="first "> '
				+ '                    <a href="http://www.lottecard.co.kr/eshopping/" target="_elife" onmouseover="lcElife_menuOver(1);"><img src="http://www.lottecard.co.kr/images/elife/gnb_elife_01.gif" alt="쇼핑"></a> '
				+ '                    <span class="snb elife_menu01" id="elifeMenu01"> '
				+ '                        <ul> '
				+ '                            <li class="first"><a href="http://www.lottecard.co.kr/eshopping/" target="_elife" class="first"><img src="http://www.lottecard.co.kr/images/elife/snb_elife_0101.gif" alt="롯데카드몰"></a></li> '
				+ '                            <li><a href="http://www.lottecard.co.kr/greenmarket/" target="_elife"><img src="http://www.lottecard.co.kr/images/elife/snb_elife_0102.gif" alt="그린마켓"></a></li> '
				+ '                            <li><a href="http://www.lottecard.co.kr/book/" target="_elife"><img src="http://www.lottecard.co.kr/images/elife/snb_elife_0103.gif" alt="도서"></a></li> '
				+ '                            <li><a href="http://www.lottecard.co.kr/remind/" target="_elife"><img src="http://www.lottecard.co.kr/images/elife/snb_elife_0104.gif" alt="기념일"></a></li> '
				+ '                            <li class="last"><a href="http://www.lottecard.co.kr/flower/" target="_elife"><img src="http://www.lottecard.co.kr/images/elife/snb_elife_0105.gif" alt="꽃배달"></a></li> '
				+ '                        </ul> '
				+ '                    </span> '
				+ '                </li> '
				+ '                <li><a href="http://www.lottecard.co.kr/travel/" target="_elife" onmouseover="lcElife_menuOver(2);"><img src="http://www.lottecard.co.kr/images/elife/gnb_elife_02.gif" alt="여행"></a></li> '
				+ '                <li><a href="http://www.lottecard.co.kr/culture/" target="_elife" onmouseover="lcElife_menuOver(3);"><img src="http://www.lottecard.co.kr/images/elife/gnb_elife_03.gif" alt="문화공연"></a></li> '
				+ '                <li><a href="http://www.lottecard.co.kr/mobilemall/" target="_elife" onmouseover="lcElife_menuOver(4);"><img src="http://www.lottecard.co.kr/images/elife/gnb_elife_04.gif" alt="휴대폰몰"></a></li> '
				+ '                <li><a href="http://www.lottecard.co.kr/wedding/" target="_elife" onmouseover="lcElife_menuOver(5);"><img src="http://www.lottecard.co.kr/images/elife/gnb_elife_05.gif" alt="웨딩"></a></li> '
				+ '                <li><a href="http://www.lottecard.co.kr/insurance/" target="_elife" onmouseover="lcElife_menuOver(6);"><img src="http://www.lottecard.co.kr/images/elife/gnb_elife_06.gif" alt="보험"></a></li> '
				+ '                <li class="last"> '
				+ '                    <a href="http://www.lottecard.co.kr/golf/" target="_elife" onmouseover="lcElife_menuOver(7);"><img src="http://www.lottecard.co.kr/images/elife/gnb_elife_07.gif" alt="생활"></a> '
				+ '                    <span class="snb elife_menu07" id="elifeMenu07"> '
				+ '                        <ul> '
				+ '                            <li class="first"><a href="http://www.lottecard.co.kr/golf/" target="_elife"><img src="http://www.lottecard.co.kr/images/elife/snb_elife_0701.gif" alt="골프"></a></li> '
				+ '                            <li><a href="http://www.lottecard.co.kr/autorental/" target="_elife"><img src="http://www.lottecard.co.kr/images/elife/snb_elife_0702.gif" alt="자동차"></a></li> '
				+ '                            <li><a href="http://www.lottecard.co.kr/sangjo/" target="_elife"><img src="http://www.lottecard.co.kr/images/elife/snb_elife_0703.gif" alt="상조"></a></li> '
				+ '                            <li class="last" style="padding-right: 0px;"><a href="http://www.lottecard.co.kr/homecare/" target="_elife"><img src="http://www.lottecard.co.kr/images/elife/snb_elife_0704.gif" alt="홈케어"></a></li> '
				+ '                        </ul> '
				+ '                    </span> '
				+ '                </li> '
				+ '            </ul> '
				+ '            <ul id="elife-sub01" class="elife-sub sst"> '
				+ '                <li class="sub01 txt" style="background:none;"><a href="#"><img alt="" src="http://www.lottecard.co.kr/images/common/elife_sub01_txt.gif" alt="롯데카드몰을 통하면 매달 포인트 적립과 할인 혜택이 가득!"></a></li> '
				+ '            </ul> '
				+ '        </div> '
				+ '    </div> '
				+ '</div>';
			partnerHeaderHeight = 69;
		...
		}else if(  nPartnerCookieValue == '1411') {   // 북앤라이프
			partnerHeaderInfo = '<script type="text/javascript" src="http://www.booknlife.com/BNL_NEW/mall/11st.js"></script>';
            partnerHeaderHeight = 110;
		}else if(  nPartnerCookieValue == '1442') {   // KB국민카드
			partnerHeaderInfo = '<script type="text/javascript" src="http://life.kbcard.com/cxl/jsp/js/second_gnb.js"></script>';
			partnerHeaderHeight = 115;
		}else if(  nPartnerCookieValue == '1583' || nPartnerCookieValue == '1584' || nPartnerCookieValue == '1585'
			 || nPartnerCookieValue == '1586' || nPartnerCookieValue == '1587') {   // 네이트 쇼핑
			partnerHeaderInfo = '<script type="text/javascript" src="http://shopping.daum.net/header/shopheader.nate"></script>';
			partnerHeaderHeight = 83;
		}else if(  nPartnerCookieValue == '1513' ){
			partnerHeaderInfo = '<script type="text/javascript" src="http://citi.truemobile.com/cardmall/pc/js/header_11st.js"></script>';
			partnerHeaderHeight = 112;
		}
	}
} catch (e) {}
...
function setSearchTarget( code, gubun ) {
	...
	if ( code == "M" ) {	// 대표상품
		...
		actionStr = "http://tour.11st.co.kr/vertical/Tour11stSearchAction.tmall";
		method = "getTour11stSearch";
	} else if ( code == "TOUR" ) {// 여행
		actionStr = "http://tour.11st.co.kr/vertical/Tour11stSearchAction.tmall";
		method = "getTour11stSearch";
	} else if ( code == "OVERSEAS" ) {// 해외호텔
		actionStr = "http://tour.11st.co.kr/vertical/Tour11stSearchAction.tmall";
		method = "getTour11stGlobalSearch";
	} else if ( code == "DOMESTIC" ) {// 국내숙박
		actionStr = "http://tour.11st.co.kr/vertical/Tour11stSearchAction.tmall";
		method = "getTour11stDomesticSearch";
	} else if ( code == "SEMANTIC" ) {// 시맨틱검색
...
if(isUTF8 == undefined || isUTF8 == null || isUTF8 == false){
	document.write('<script type="text/javascript" charset="euc-kr" src="' + getCommonImgUrl("http://www.11st.co.kr/html/reserveKeywordList.js") + '"></script>');
}
...
function vMy(flag)
{
	vLayer(flag, "mYInFo_11st",
		...
		+"<dd><a href=\"javascript:goStatUrl(_GNB_CONTEXT_PATH_ +'/register/getGradeInfo.tmall?method=getGrade','A0204');\">구매등급혜택</a></dd>"
...
function vSeller(flag)
{
	vLayer(flag, "sellerC_11st",
		...
		+"<dd><a href=\"javascript:goStatUrl('http://town.soffice.11st.co.kr','MAA0115');\">타운셀러오피스</a></dd>"
		...
		+"<dd><a href=\"javascript:goStatUrl(_SELLER_URL_,'MAA0114');\">판매자서비스센터</a></dd>"
		//20121203_yym추가/변경
...
var searchManager = {
	...
	init : function(renew){
		...
		var _src =  "/jsp/common/autoKeywordComplete.jsp?"+_param;
...
//SSO로그인 체크
if(funcCheckIsSSOLogin() && !funcCheckIsLogin()){
	document.write("<iframe src=\"https://login.11st.co.kr/sso/init.tmall\" width=\"0\" height=\"0\"></iframe>");
}
...
var StartPageManager=function (){
    ...
    var goEnglish11st=function (){
        location.href="http://english.11st.co.kr";
    };
			...
			jQuery.ajax({
				...
				success : function(data) {
					if ( typeof(data) != 'undefined' ) {
						...
						if(_conf.action =='rm'){
							var img2 = new Image();
							img2.src = "http://ad.hotclick.netinsight.co.kr/hotclick/" + _conf.action + "-cuki?"+ "method=" + _conf.method + "&prod_no=" + _conf.prdNoList + "&ctgr_no=" + _conf.ctgrNoList;
						}else{
