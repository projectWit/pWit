					...
					<tr>
							...
							<td>
								<!-- 비연합강좌인경우 -->
										...
										<span class="lecTchName">이남승</span>
									</td>
							<td class="txtL">
								...
								<p class="lecTit">
									<a href="#">[2014 고3 9월모의평가해설] 한국지리</a>
										</p>
							...
							<td>
								<span class="lecStatus">
									<span class="mvNum">
										1</span> / 1</span>
								<span class="lecStatus">(<span class="captionNum">0</span> / 1)</span></td>
							<td>
								<a href="#none"><img onclick="ShowPreviewPlayer('S20140000730', event);" alt="맛보기 강좌" src="http://image.ebsi.co.kr/ebsi/images/potalUI/entrance/btn_play.jpg"></a>
									</td>
							<td>
