...
<form method="post" action="" name="regForm" id="regForm">
    <table cellspacing="0" class="info-table">
        ...
        <tr><td class="table-label">시험일자</td><td class="table-input"><input type="text" size=15 id="testDate" name="testDate"></td>
            <td class="table-label">평균점수</td><td class="table-input"><input type="number" min=0 max=100> 점</td>
            <td class="table-label"><!-- temp --></td><td class="table-input"><!-- temp --></td></tr>
        <tr><td class="table-label">선생님메모</td><td class="table-input" colspan=5><textarea rows="3" style="margin-right: 0px; padding-right: 0px; width: 99%;"></textarea></td></tr>
