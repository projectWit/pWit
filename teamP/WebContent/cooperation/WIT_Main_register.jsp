...
<body>
	<div id="section_register_main"
		...
		<table align="center"
			...
			<tr>
				<td colspan="3"><img src="/teamP/cooperation/images/register_welcome.png" style="width: 600px;"></td>
			</tr>
			<tr>
			...
			<tr>
				<td><a href="WIT_Main_register_common.jsp"> <img
						src="/teamP/cooperation/images/register_common.png"
						style="width: 250px; height: 250px;"></a></td>
				<td style="width: 100px;"></td>
				<td><a href="WIT_Main_register_company.jsp"><img
						src="/teamP/cooperation/images/register_company.png"
