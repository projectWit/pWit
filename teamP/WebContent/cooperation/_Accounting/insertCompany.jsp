...
function companyLists() {
	...
	window.open('companyLists.jsp', '', features);
};	
</script>
<body>
			...
			<table width="400" height="100" border='0' cellspacing='0'
				...
				<tr>
					<td align='center'>
						<table align="center">
							<tr>
								<td align='center' class='bigtitle'>회사등록</td>
							</tr>
						</table>
					</td>
				</tr>
