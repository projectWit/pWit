...
function departmentLists() {
	var features = "width=480px, height=550px, resizable=no, scrollbars=no, top=200, left=200, toolbar=no";
	window.open('departmentLists.jsp', '', features);
};	
</script>
<body>
	<div id="wrap" style="margin-left: 40px;">
			...
			<table width="400" height="100" border='0' cellspacing='0'
				...
				<tr>
					<td align='center'>
						<table align="center">
							<tr>
								<td align='center' class='bigtitle'>프로젝트입력</td>
							</tr>
						</table>
					</td>
				</tr>
		...
		<table width="400">
			...
			<tbody>
				<tr>
					<th class="p_th left">부서</th>
					<td class="p_td left"><input type="text" maxlength="8" size="20" 
						style="background-color: #F6F6F6; height: 28px;" onclick="departmentLists()" />
						<input type="button" value="조회" style="height: 25px;" onclick="departmentLists()" /></td>
				</tr>
				<tr>
					<th class="p_th left">프로젝트명</th>
					<td class="p_td left"> <input type="text"  maxlength="8" size="20"
						style="background-color: #F6F6F6; height: 28px;" /></td>
				</tr>
				<tr>
					<th class="p_th left">프로젝트설명</th>
					<td class="p_td left"><input type="text" size="42"
						style="background-color: #F6F6F6; height: 28px;" /></td>
				</tr>
				<tr>
					<th class="p_th left">예산</th>
					<td class="p_td left">
