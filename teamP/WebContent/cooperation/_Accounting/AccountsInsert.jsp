...
<body onload="insertAccounts.aName.select()">
<form action="AccountsInsertPro.jsp" method="post" id="insertAccounts">
	<div id="wrap" style="margin-left: 40px; width: 400px;">
		...
		<div class="container H_38px" style="width: 400px;">
			<p class="float_right right">
				<a onclick="Accounts_sSelect()">[목록]</a>
			</p>			
		</div>
		...
		<table width="400">
			...
			<tbody>
				<tr>
					...
					<td class="p_td left"><input type="text"
						maxlength="8" size="42" name="aName" id="aName"
						style="background-color: #F6F6F6; height: 28px;" /></td>
				</tr>
				<tr>
					<th class="p_th left">계정설명</th>
					<td class="p_td left"><input type="text" size="42" name="aContents"
						style="background-color: #F6F6F6; height: 28px;" /></td>
				</tr>
				<tr>
					<th class="p_th left">작성자</th>
					<td class="p_td left">
					<input type="text" size="20" name="eId"
