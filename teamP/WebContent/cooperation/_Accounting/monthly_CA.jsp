...
<body>
	<div id="wrap">
			...
			<table width="1000px" height="50" border='0' cellspacing='0' cellpadding='0'>
				<tr>
					<td align='center'>
						<table>
							<tr>
								<td align='center' class='bigtitle'>월별원가분석</td>
							</tr>
						</table>
					</td>
				</tr>
		...
		<table class="p_table" summary="">
			...
			sum+=18500;%>
				<tr>
					<td class="p_td" style="background-color: #F6F6F6;">당기원가</td>
				...
				<tr>
					<td class="p_td" style="background-color: #F6F6F6;">기초재고원가</td>
				...
				<tr>
					<td class="p_td" style="background-color: #F6F6F6;">합계</td>
					<td class="p_td right" style="background-color: #F6F6F6;">500,000</td>
					<td class="p_td right" style="background-color: #F6F6F6;">62,500</td>
					<td class="p_td right" style="background-color: #F6F6F6;">31,250</td>
					<td class="p_td right" style="background-color: #F6F6F6;">31,250</td>
					<td class="p_td right" style="background-color: #F6F6F6;">31,250</td>
					<td class="p_td right" style="background-color: #F6F6F6;">31,250</td>
					<td class="p_td right" style="background-color: #F6F6F6;">31,250</td>
				...
				<tr>
					<td class="p_td" style="background-color: #F6F6F6;">기말재고원가</td>
				...
				<tr>
					<td class="p_td" style="background-color: #F6F6F6;">당기순원가</td>
					<td class="p_td right" style="background-color: #F6F6F6;">200,000</td>
