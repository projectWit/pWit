...
calendarIDs = [ 'fDate' ]; // 달력이 추가될 태그의 id
...
<body>
<form action="FixedAssetInsertPro.jsp" method="post">
			...
			<tbody>
				<tr>
					...
					<td class="p_td left"><input type="text" maxlength="8" size="20" 
						style="background-color: #F6F6F6; height: 28px;" name="fName" />
					</td>
				</tr>
				<tr>
					<th class="p_th left">고정자산일자</th>
					<td class="p_td left"> <input type="text"  maxlength="8" size="20"
						style="background-color: #F6F6F6; height: 28px;" id="fDate" name="fDate"/></td>
				</tr>
				<tr>
					<th class="p_th left">단가</th>
					<td class="p_td left"><input type="text" size="20" name="fAmounts"
						style="background-color: #F6F6F6; height: 28px;" /></td>
				</tr>
				<tr>
					<th class="p_th left">수량</th>
					<td class="p_td left">
					<input type="number" size="20" name="fQuantity"
						style="background-color: #F6F6F6; height: 28px;"/>
					</td>
				</tr>				
				<tr>
					<th class="p_th left">감가상각</th>
					<td class="p_td left"><input type="number" size="20" name="f_eCode"
						style="background-color: #F6F6F6; height: 28px;" />
						<input type="button" value="조회" style="height: 25px;" /></td>
				</tr>
				<tr>
					<th class="p_th left">감가상각개월 수</th>
					<td class="p_td left"><input type="number" size="20" name="fMonths"
						style="background-color: #F6F6F6; height: 28px;" />
						<input type="button" value="조회" style="height: 25px;" /></td>
				</tr>
				<tr>
					<th class="p_th left">상태</th>
					<td class="p_td left"><input type="number" size="20" name="f_sCode"
						style="background-color: #F6F6F6; height: 28px;" />
						<input type="button" value="조회" style="height: 25px;" /></td>
				</tr>
				<tr>
					<th class="p_th left">적요</th>
					<td class="p_td left"><input type="text" size="42" name="fContents"
						style="background-color: #F6F6F6; height: 28px;" /></td>
				</tr>
			</tbody>
			<tr>
