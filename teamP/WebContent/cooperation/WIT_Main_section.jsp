...
<div class="ibm-container" id="ibm-leadspace-head">
	...
	<!-- 작은 이미지 영역 -->
		<div class="ibm-ribbon-nav">
			...
			<a href="#" class="">Show carousel 4<div class="ibm-ribbon-view ibm-lead-thumb-4">
				<div class="ibm-pagination-overlay" style="opacity: 1; display: none;">
					<span class="ibm-lead-thumb-4"></span><h2>Cloud computing made clear</h2><p>Infrastructure architect Chris Dotson shares his insights</p>
				</div></div>
			</a>
		</div>
	<!-- 작은 이미지 영역 -->
