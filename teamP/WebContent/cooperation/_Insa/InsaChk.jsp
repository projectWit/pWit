		...
		<div id="wrap">
			...
			<div id="contents">
				<table summary="" class="entry H_15px">
					...
					<tr>
						<th>퇴사일자</th>
						<td><input name="DtOut" type="text" id="DtOut" size="12" readonly="readonly"
							maxlength="8" value="" class="default"></td>


						<th>퇴사사유</th>
						<td><input name="OutReason" type="text" maxlength="60" readonly="readonly"
							id="OutReason" class="default" style="width: 160px;" /></td>
					</tr>
					<tr>
						<th>전화</th>
						<td><input name="Tel" type="text" value="010-3096-0955"
							readonly="readonly" maxlength="20" id="Tel" class="default"							
						...
						<td><input name="Phone" type="text" maxlength="20"
							...
							readonly="readonly" onkeydown="jsOnlyNumberKey4(this);"
							style="width: 160px; ime-mode: disabled" /></td>
					</tr>
					<tr>
						<th>부서코드</th>
					...
					<tr>
						...
						<td colspan="4"><a href="#" id="btnSearchPostNo"
							name="btnSearchPostNo" class="link-blue">우편번호검색</a>
