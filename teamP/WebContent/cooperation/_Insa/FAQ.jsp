...
<script type="text/javascript">
	function valSend(gubun, no) {
		document.FaqFrm.gubun.value = gubun;
		document.FaqFrm.no.value = no;
		document.FaqFrm.submit();
	}
</script>

<body>
	<form name="FaqFrm" action="FAQMain.jsp">
					...
					<table border=0 width='100%'>
						<tr>
							...
							<td id='bl_search'><input type=checkbox name=shname
								value="ok">이름 <input type=checkbox name=ssubject
								value="ok" checked>제목 <input type=checkbox name=scontent
								value="ok">내용 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 검색어 <input
								type=text name=stext size=10> <a
