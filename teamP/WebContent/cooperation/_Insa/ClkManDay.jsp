					...
					<fieldset>
						...
						<table class="search_t fixed">
							...
							<tr>
								...
								<td><input type="text" name="txtId" id="txtId"
									...
									name="Name" id="Name" class="grayleft" readonly="readonly"
							...
							<tr>
								...
								<td><input type="text" name="txtSiteCd" id="txtSiteCd"
									...
									type="text" name="Site" id="Site" size="15" value=""
							...
							<tr>
								...
								<td><input type="radio" name="rbIoType1" id="radio1"
									...
									value="3" />출/퇴근<input type="radio" name="rbIoType4"
									id="radio4" onkeypress="return fnEnterHandles1(this,'1');"
									value="4" />휴가</td>
							</tr>
							...
							<tr>
								...
								<td><input type="checkbox" name="cbIoType1" id="cbIoType1"
									...
									checked="checked" />모든날짜검색 <input type="checkbox"
									name="cbIoType2" id="cbIoType2"
									onkeypress="return fnEnterHandles1(this,'1');" value="1" />IP체크</td>
							</tr>
						...
						<div id="search-button" class="search-button">
							<span class="btn gray"><input name="btnSearch"
								type="button" id="btnSearch" value="검색(F8)" onclick="Search()" /></span>
