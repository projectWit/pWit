	...
	<center>
		...
		<script type="text/javascript">
			function valSend(gubun, no) {
				...
				document.BoaMFrm.gue_no.value = no;
							...
							<td><table id='bw_table' class='bw_border_bottom'
									...
									<tr>
										...
										<td class='bw_title_color'><span
											style="font-family: '굴림체'"><%=dto.getbTitle()%></span></td>
									</tr>
									<tr>
										<td class='bw_title_color bw_title'
			...
			<tr>
				<td align="center"><div id='bw_button'>
						<img src='img/delete.gif' border=0>&nbsp;<a
							href="BoaLeftMan.jsp"><img src='img/icon_list.gif' border=0
							alt='목록' /></a>
					</div></td>
			</tr>
			<tr>
