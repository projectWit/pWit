...
<script type="text/javascript">
function PopUpCar() {
	window.open("DocCarIns.jsp", "", "width = 1000px, height = 800px");
}
</script>
<style>
#ck {
...
<body>
		<div id="wrap">
			<div class="new-title">
				<div class="title-leftarea">경력증명서</div>
			...
			<div id="contents">
				<table summary="" class="entry H_0px fixed">
					...
					<tr>
						<th>기타사항</th>
						<td><textarea cols="102" rows="15"></textarea></td>
					</tr>
				...
				<div>
					<span class="btn blue"> <input name="btnSend" type="button"
						id="btnSend" value="저장/결재(F7)" onclick  = "PopUpCar()"/>
					</span> <a id="lnkSave2"
