...
<%
	...
	List dtoL = dao.boaSelList();
%>
<script type="text/javascript">
	function valSend(gubun, no) {
		document.BoaMFrm.gubun.value = gubun;
		document.BoaMFrm.no.value = no;
		document.BoaMFrm.submit();
	}
</script>
<body>
	<form action="BoaMainMan.jsp" name="BoaMFrm">
					...
					<table border=0 width='100%'>
						<tr>
							...
							<td id='bl_search'><input type=checkbox name=shname
								...
								name=ssubject value="ok" checked onclick="change(2)">제목
								<input type=checkbox name=scontent value="ok"
								onclick="change(3)">내용
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 검색어 <input type=text
					...
					<table id='bl_table' border='0' cellpadding='0' cellspacing='0'
						...
						<tr class="bl_oddline">
							...
							<td class='bl_list bl_subject leftalign' colspan="1"
								...
								onClick="valSend('listT', '<%=dto.getbSeq()%>')"><%=dto.getbTitle()%>&nbsp;&nbsp;
							</td>
							<td class='bl_list bl_date'><d
 ...
 %>
							...
							<td class='bl_list bl_hits'><%=dto.getbCnt()%></td>
						</tr>
						<%
							}
						%>
				...
				<td align="center"><br> <!-- PAGING START-->
					...
					<table width='100%' border='0' cellpadding="0" cellspacing="0">
						<tr>
							...
							<td id='bl_linkbutton'><a href="BoaLeftManIns.jsp"><img
