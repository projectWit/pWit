			...
			<dl class="left_title">
				...
				<dt id="class113">
					<span class="float_left" style="width: 167px"><a
						href="DocLeft.jsp" id="a119_1">재직증명서</a></span>
				</dt>

				<dt id="class113">
					<span class="float_left" style="width: 167px"><a
						href="DocLeftCar.jsp" id="a119_1">경력증명서</a></span>
				</dt>

				<dt id="class113">
					<span class="float_left" style="width: 167px"><a
						href="DocLeftTrip.jsp" id="a119_1">출장증명서</a></span>
				</dt>

				<dt id="class113">
					<span class="float_left" style="width: 167px"><a
						href="DocLeftOut.jsp" id="a119_1">퇴직증명서</a></span>
				</dt>
