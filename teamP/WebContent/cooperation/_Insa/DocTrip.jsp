...
<script type="text/javascript">
	...
	function PopUpTrip() {
		window.open("DocTripIns.jsp", "", "width = 1000px, height = 800px");
	}
</script>
<style>
#ck {
...
<form>
		<div id="wrap">
			<div class="new-title">
				<div class="title-leftarea">출장증명서</div>
			...
			<div id="contents">
				<table summary="" class="entry H_0px fixed">
					...
					<tr>
						...
						<td colspan="4"><input name="FromDt" type="text" id="FromDt"
							...
							name="ToDt" type="text" id="ToDt" size="12" maxlength="8"
					...
					<tr>
						<td><input type="text" value="사원" style="width: 70%"class = "default" /></td>
						<td><input type="text" value="영업팀 " style="width: 70%" class = "default"/></td>
						<td colspan="2"><input type="text" value="베일 "class = "default"
							style="width: 70%" /></td>
					</tr>
					...
					<tr>
						<th>기타사항</th>
						<td><textarea cols="97" rows="15"></textarea></td>
					</tr>
				...
				<div>
					<span class="btn blue"> <input name="btnSend" type="button"
						id="btnSend" value="저장/결재(F7)" onclick = "PopUpTrip()"/>
					</span> <a id="lnkSave2"
