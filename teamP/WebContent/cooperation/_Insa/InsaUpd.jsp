				...
				<table summary="" class="entry H_15px">
					...
					<tr>
						...
						<td><input name="JobDutyCd" type="text" id="JobDutyCd"
							...
							id="JobDuty" value="팀원" class="grayleft"
					...
					<tr>
						...
						<td><input name="DepCd" type="text" value="00002"
							maxlength="14" id="DepCd" class="blue_zoom"
							style="width: 46px;" /><img src="img/Find.gif"
								id="imgSearchEmpSite" width="22px" height="19px" alt="검색" onclick = "PopUpDep()"/><input
								name="Dep" type="text" value="경영지원팀"
