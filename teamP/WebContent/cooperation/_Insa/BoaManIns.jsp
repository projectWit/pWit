		...
		$(document).ready(function() {
			...
			<form name=attachform method=post>
				<input type=hidden name=code value="pippin1"> <input
					type=hidden name=size value="204800"> <input type=hidden
					name=maxsize value=""> <input type=hidden name=img_maxwidth
					value="550"> <input type=hidden name=img_resize value="N">
				<input type=hidden name=servername value="special5"> <input
					type=hidden name=url value="www.pippin.co.kr"> <input
					type=hidden name=org value="pippin1"> <input type="hidden"
					name="fileobj_name" value="" /> <input type="hidden"
					name="device_type" value="PC" />
