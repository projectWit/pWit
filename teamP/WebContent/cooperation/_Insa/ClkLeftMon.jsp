			...
			<dl class="left_title">
				...
				<dt id="class113">
					<span class="float_left" style="width: 167px"><a
						href="ClockLeft.jsp" id="a119_1">일일근태작성</a></span>
				</dt>

				<dt id="class113">
					<span class="float_left" style="width: 167px"><a
						href="ClkLeftMon.jsp" id="a119_1">월별근태조회</a></span>
				</dt>

				<dt id="class113">
					<span class="float_left" style="width: 167px"> <a
						href="ClockLeftVac.jsp" title="조회/인쇄" id="a119_1">연월차등록</a></span>
				</dt>

				<dt id="class113">
					<span class="float_left" style="width: 167px"> <a
						href = "ClockLeftEval.jsp"id="a119_1">근무평가</a></span>
				</dt>
			</dl>
			<dl></dl>
		</div>
		<div style="float: left; width: 80%; margin-left: 30px">
			<jsp:include page="ClockMon.jsp" />
		</div>
	</div>
</body>
