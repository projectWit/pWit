...
<body id="leftmenu">
	<div style="width: 100%; margin: auto;">
			...
			<dl class="left_title">
				<dt id="class113">
					<span class="float_left" style="width: 167px"> <a
						href="InsaLeftManList.jsp" title="조회/인쇄" id="a119_1">인사기록표</a></span>
				</dt>
				<dt id="class113">
					<span class="float_left" style="width: 167px"><a
						href="InsaLeftMan.jsp" id="a119_1" title="기타코드등록">인사기록표작성</a></span>
				</dt>


				<dt id="class113">
					<span class="float_left" style="width: 167px"> <a
						href="InsaLeftManUpd.jsp" title="기본사항등록" id="a119_1">직원정보수정/삭제</a></span>
				</dt>
		...
		<div style="float: left; width: 80%; margin-left: 30px">
			<jsp:include page="InsaManUpdList.jsp" />
