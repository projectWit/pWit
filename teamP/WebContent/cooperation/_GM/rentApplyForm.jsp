...
function SearchClub(id) {
	window.open("clubcheck.jsp?mId="+id, "", "width = 530px, height = 300px");
}
function sendSubmit() {
	document.frmInput.action="/teamP/rentInsert.gm";
						...
						<fieldset style="border: 0 solid transparent;">
							...
							<table
								...
								<tbody>
									...
									<tr>
										<th scope="row"><label for="cName">단체명</label></th>
										<td><input type="hidden" name="cId" id="cId" /><input type="text" id="cName"
											name="cName" style="font-size: 12px;"readonly="readonly"/>&nbsp;&nbsp;<img src="img/search_btn.gif" style="cursor:pointer;" onclick="SearchClub('${list.get(0).mId }')"/></td>
									...
									<tr>
										<th scope="row"><label for="rDay">사용일</label></th>
										<td class="font"><input type="text"  id="rDay" name="rDay"  />
							...
							<script type="text/javascript">
								CalAddCss(); // !!제일 상단에 필수!!
								initCal({id : "rDay",	type : "day",	today : "y",icon : "y"	});
							</script>
									<tr>
