...
<div id="sidebar" style="float:left; width:200px; margin-top:10px;">
	<div id="sidebar_1" class="sidebar one_third">
      <aside>
        ...
        <nav>
          <ul>
            <li><a href="#" id='member-0'>개인정보</a></li>
            <li><a href="#" id='member-1'>단체정보</a></li>
            <li><a href="#" id='member-2'>회원정보수정</a></li>
            <li><a href="#" id='member-3'>사용자 탈퇴</a></li>
            <li><a href="#" id='member-4'>내 수강목록</a></li>
            <li><a href="#" id='member-5'>수강신청확인</a></li>
          </ul>
        </nav>
        <!-- /nav -->
	</aside>
