...
<title>시설 신청 양식</title>
<link rel="stylesheet" type="text/css" href="css/rentlayout.css"
	media="all" />
<link rel="stylesheet" type="text/css" href="css/sub06.css" media="all" />
<style>
ul {
	list-style: none;
}
...
<script type="text/javascript">
	...
	function _ajaxMenuCount(gubun) {
		...
		j$.ajax({
			type : "POST",
			url : "/common/xmlHttp/procMenuCount.asp",
			data : mData,
				...
				<div id="tab_list02">
					<div class="hall_join">
						<fieldset style="border: 0 solid transparent;">
							<legend>직원 시설 사용 신청</legend>
							<table class="sComm_write01">
								...
								<tbody>
									...
									<tr>
										<th scope="row"><label for="team_name">강좌명</label></th>
									...
									<tr><th scope="row">사용목적</th><td><input type="text" class="input09" id="usereason" name="usereason" /></td></tr>
								</tbody>
							</table>
						</fieldset>

						<span class="fRight01"> <input type="image"
							src="img/bt_submit.jpg" alt="등록" />&nbsp;&nbsp;<input type="image"
							src="img/bt_cancle.jpg" alt="취소" /></a>
						</span>
					</div>
				</div>
			</div>
