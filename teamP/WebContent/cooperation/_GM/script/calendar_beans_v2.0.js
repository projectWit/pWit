...
function initCal(obj){
	...
	/*var iconUrl    = obj.iconUrl == null ? "/teamP/cooperation/_GM/img/mini_calendar.gif" : obj.iconUrl ; */

	// 달력 레이아웃(전체틀+월선택)그리기
	drawCalForm(calId,obj.id,calType,minYear,maxYear,todayYN,iconYN);
...
// 달력 폼 그리기 
function drawCalForm(id,tId,calType,min,max,todayYN,iconYN){ // tId = 입력창ID				
