...
$(document).ready(function(e) {
   ...
   $('#member-1').click(function(e) {
	   $('#main').load('/memberSearch.jsp');
   });
   $('#member-2').click(function(e) {
	  $('#main').load('memberDrop.jsp') 
   });
   $('#member-3').click(function(e) {
	   $("#main").load('/teamP/questionlist.gm');
   });
});
</script>
<body>
...
<div id="sidebar" style="float:left; width:200px; margin-top:10px;">
	<div id="sidebar_1" class="sidebar one_third">
      <aside>
        ...
        <nav>
          <ul>
            <li><a href="#" id='member-0'>회원 목록</a></li>
            <li><a href="#" id='member-1'>회원 조회</a></li>
            <li><a href="#" id='member-2'>회원 탈퇴</a></li>
            <li><a href="#" id='member-3'>1:1 문의 현황</a></li>
          </ul>
        </nav>
        <!-- /nav -->
	</aside>
