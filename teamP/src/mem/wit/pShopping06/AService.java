...
/*		WSSellerDAO dao = context.getBean("wsSellerDAO", WSSellerDAO.class);
	 ...
	 * Sellers 관련 서비스들
	 **********************************************************************************************/
	public int addSeller(WSSellerDTO seller) {			// 방금 삽입한 레코드의 prd_code를 반환함
		ApplicationContext context = new GenericXmlApplicationContext("applicationContext.xml");
		WSSellerDAO dao = context.getBean("wsSellerDAO", WSSellerDAO.class);
		return dao.add(seller);
	}
	
	public int updateSeller(WSSellerDTO seller) {
		ApplicationContext context = new GenericXmlApplicationContext("applicationContext.xml");
		WSSellerDAO dao = context.getBean("wsSellerDAO", WSSellerDAO.class);
		return dao.update(seller);
	}
	
	public List<WSSellerDTO> listSellers() {
		ApplicationContext context = new GenericXmlApplicationContext("applicationContext.xml");
		WSSellerDAO dao = context.getBean("wsSellerDAO", WSSellerDAO.class);
		return dao.getAll();		
	}
	...
	public int isSeller(String id) {
		ApplicationContext context = new GenericXmlApplicationContext("applicationContext.xml");
		WSSellerDAO dao = context.getBean("wsSellerDAO", WSSellerDAO.class);
		return dao.isSeller(id);		
	}
	
	public WSSellerDTO getValidSeller(String id, String pwd) {
		ApplicationContext context = new GenericXmlApplicationContext("applicationContext.xml");
		WSSellerDAO dao = context.getBean("wsSellerDAO", WSSellerDAO.class);
		if(dao.isValidSeller(id, pwd)==1) {
			return dao.getValidSeller(id, pwd);	
		}
		else {
			WSSellerDTO emptyDTO = new WSSellerDTO();
			return emptyDTO;
		}
	 ...
	 * Product 관련 서비스들
	 **********************************************************************************************/
	public int addProduct(WSProductDTO prd) {
		ApplicationContext context = new GenericXmlApplicationContext("applicationContext.xml");
		WSProductDAO dao = context.getBean("wsProductDAO", WSProductDAO.class);
		return dao.add(prd);
	}
	
	public WSProductDTO getProductInfo(int prd_code) {
		ApplicationContext context = new GenericXmlApplicationContext("applicationContext.xml");
		WSProductDAO dao = context.getBean("wsProductDAO", WSProductDAO.class);
		return dao.get(prd_code);		
	}
	
	public WSProductDTO getRecentProductInfo() {
		ApplicationContext context = new GenericXmlApplicationContext("applicationContext.xml");
		WSProductDAO dao = context.getBean("wsProductDAO", WSProductDAO.class);
		return dao.getRecent();		
	}
	
	public int addProductImage(int prd_code, String mainImg, String detailImg ) {
		ApplicationContext context = new GenericXmlApplicationContext("applicationContext.xml");
		WSProductDAO dao = context.getBean("wsProductDAO", WSProductDAO.class);
		return dao.addImage(prd_code, mainImg, detailImg);
	}
	...
	public int isValidMember(String mem_id, String mem_pwd ) {
		ApplicationContext context = new GenericXmlApplicationContext("applicationContext.xml");
		WSMemberSubDAO dao = context.getBean("wsMemberSubDAO", WSMemberSubDAO.class);
		return dao.isValid(mem_id, mem_pwd);
	}
	...
	public WSMainCateDTO getMainCate(int prd_mainCate) {
		ApplicationContext context = new GenericXmlApplicationContext("applicationContext.xml");
		WSMainCateDAO dao = context.getBean("wsMainCateDAO", WSMainCateDAO.class);
		return dao.get(prd_mainCate);		
	}
	...
	public WSSubCateDTO getSubCate(int prd_mainCate, int prd_subCate) {
		ApplicationContext context = new GenericXmlApplicationContext("applicationContext.xml");
		WSSubCateDAO dao = context.getBean("wsSubCateDAO", WSSubCateDAO.class);
		return dao.get(prd_mainCate, prd_subCate);		
	}
	
	public WSNationDTO getNation(int prd_nation) {
		ApplicationContext context = new GenericXmlApplicationContext("applicationContext.xml");
		WSNationDAO dao = context.getBean("wsNationDAO", WSNationDAO.class);
		return dao.get(prd_nation);		
	}
	...
	public ZipcodesDTO searchZipcodeBySeq(int seq) {
		ApplicationContext context = new GenericXmlApplicationContext("applicationContext.xml");
		ZipcodesDAO dao = context.getBean("zipcodesDAO", ZipcodesDAO.class);
		return dao.get(seq);
	...
	public String getAddress(int seq) {
		ApplicationContext context = new GenericXmlApplicationContext("applicationContext.xml");
		ZipcodesDAO dao = context.getBean("zipcodesDAO", ZipcodesDAO.class);
		ZipcodesDTO dto = dao.get(seq);
		String address = dto.getSido() + " " + dto.getGugun() + " " + dto.getDong();
		if(dto.getRi()!=null) address += " " + dto.getRi();
		if(dto.getBunji()!=null) address += " " + dto.getBunji();
